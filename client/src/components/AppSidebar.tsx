import { LayoutDashboard, TrendingUp, Wallet, BarChart3, Settings, LogOut } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const menuItems = [
  ...
  { title: "Live Matches", icon: TrendingUp, url: "/matches" },
    ...
    <Sidebar>
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-bold">BetPro Exchange</h2>
